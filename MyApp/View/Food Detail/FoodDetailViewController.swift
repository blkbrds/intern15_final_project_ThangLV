...
final class FoodDetailViewController: ViewController {
    ...
    @IBOutlet weak var showMoreCountryFoodsButton: UIButton!
    @IBOutlet private weak var categorySimilarCollectionView: UICollectionView!
    @IBOutlet weak var showMoreCategoryFoodsButton: UIButton!
    @IBOutlet weak var tableHeight: NSLayoutConstraint!
    @IBOutlet weak var similarCountryFoodsCollectionViewHeight: NSLayoutConstraint!
    @IBOutlet weak var similarCategoryFoodsCollectionViewHeight: NSLayoutConstraint!
    ...
    private func updateUI() {
        ...
        tableHeight.constant = CGFloat((count - 3) * 40)
    ...
    private func configCountrySimilarCollectionView() {
        ...
        switch numberOfSimilarCountryFoods > 8 {
        case true:
            similarCountryFoodsCollectionViewHeight.constant = 4 * CGFloat(UIScreen.main.bounds.width / 2) - CGFloat(UIScreen.main.bounds.width / 2)
        case false:
    ...
    private func configCategorySimilarCollectionView() {
        ...
        switch numberOfSimilarCategoryFoods > 8 {
        case true:
            similarCategoryFoodsCollectionViewHeight.constant = 4 * CGFloat(UIScreen.main.bounds.width / 2) - CGFloat(UIScreen.main.bounds.width / 2)
        case false:
    ...
    private func configScrollView() {
        contentViewHeight.constant = detailFoodView.frame.height + tableHeight.constant + instructionTextView.frame.height + similarCountryFoodsCollectionViewHeight.constant + similarCategoryFoodsCollectionViewHeight.constant + CGFloat(550)
